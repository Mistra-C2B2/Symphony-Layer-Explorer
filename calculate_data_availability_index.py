...
class DataAvailabilityCalculator:
    ...
    def load_symphony_p02_matches(self, file_path: str = "data/symphony_p02_matches.json") -> None:
    ...
    def load_p02_analysis(self, file_path: str = "data/p02_analysis.json") -> None:
    ...
    def save_results(self, results: Dict[str, Dict[str, Any]],
                     output_file: str = "data/symphony_data_availability_index.json") -> None:
