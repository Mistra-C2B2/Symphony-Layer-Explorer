...
describe('DataService', () => {
  ...
  it('should load data successfully', async () => {
    ...
    expect(fetch).toHaveBeenCalledWith('/Symphony-Layer-Explorer/data/symphony_layers.json')
    expect(fetch).toHaveBeenCalledWith('/Symphony-Layer-Explorer/data/p02_analysis.json')
    expect(fetch).toHaveBeenCalledWith('/Symphony-Layer-Explorer/data/catalogue.json')
  })
